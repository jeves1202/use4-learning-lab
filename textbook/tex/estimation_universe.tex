...
\[
\text{alive at }t \;\to\; \underbrace{\text{hard filters}}_{\text{domestic, listed}} \;\to\; \underbrace{\text{liquidity}}_{\text{ATVR }20/10} \;\to\; \underbrace{\text{cap target}}_{\approx 99\%} \;\to\; \underbrace{\text{stability buffer}}_{\text{over time}} \;\to\; E_t.
\]
